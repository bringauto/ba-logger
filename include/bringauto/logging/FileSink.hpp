...
public:
	...
	private:
		 ...
		 */
		static void
		throwIfParamsNotValid(const std::filesystem::path &logDirectoryPath, const std::string &logFileName) {
			...
			if(!isDirWritable(logDirectoryPath)) {
				throw std::invalid_argument(
						logDirectoryPath.string() + " is not a writable, please grant correct access rights");
			}
